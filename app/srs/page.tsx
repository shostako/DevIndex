    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">SRSモード</h1>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6">
          <div className="text-center mb-6">
            ...
            <div className="text-xl text-gray-600 dark:text-gray-400">今日の復習</div>
          </div>

          <button
            onClick={handleStartReview}
            disabled={stats.reviewDueToday === 0}
            className="w-full py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 disabled:bg-gray-300 dark:disabled:bg-gray-600 disabled:cursor-not-allowed transition-colors"
          >
        ...
        {/* 統計サマリー */}
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">学習統計</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div className="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
              <div className="text-3xl font-bold text-gray-900 dark:text-white mb-1">
                {stats.totalTerms}
              </div>
              <div className="text-sm text-gray-600 dark:text-gray-400">総用語数</div>
            </div>
            ...
            <div className="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">学習済み</div>
            </div>
            ...
            <div className="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">平均難易度係数</div>
            </div>
            ...
            <div className="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">平均復習間隔（日）</div>
            </div>
          </div>
        </div>
        ...
        {/* 習得レベル別進捗 */}
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">習得レベル別進捗</h2>
