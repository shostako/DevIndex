  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-2xl mx-auto">
        {/* ヘッダー */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">クイズモード</h1>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 space-y-6">
            ...
            <div className="space-y-2">
              <label className="flex items-center p-4 border-2 border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">全用語からランダムに出題</div>
                </div>
              </label>
              ...
              <label className="flex items-center p-4 border-2 border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
                ...
                />
                <div>
                  <div className="font-medium text-gray-900">カテゴリ別</div>
                  <div className="text-sm text-gray-500">特定のカテゴリから出題</div>
                </div>
              </label>
              ...
              <label className="flex items-center p-4 border-2 border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
                ...
                />
                <div>
                  <div className="font-medium text-gray-900">苦手克服</div>
                  <div className="text-sm text-gray-500">正答率が低い用語を優先</div>
                </div>
              </label>
            </div>
          </div>
          ...
          {/* 問題数選択 */}
          <div>
            <label htmlFor="count-select" className="block text-sm font-medium text-gray-700 mb-2">
              問題数
            </label>
            <select
              id="count-select"
          ...
          <button
            ...
            className="w-full py-3 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors"
          >
            クイズを開始
          </button>
